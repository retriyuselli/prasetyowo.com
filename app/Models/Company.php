...
class Company extends Model
{
    ...
    {
        if ($this->favicon_url && Storage::disk('public')->exists($this->favicon_url)) {
            return asset('storage/'.ltrim($this->favicon_url, '/'));
        }
    ...
    public function paymentMethodSecondary(): BelongsTo
    {
        return $this->belongsTo(PaymentMethod::class, 'payment_method_secondary_id');
    }
}
